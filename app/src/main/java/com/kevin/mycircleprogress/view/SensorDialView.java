...
public class SensorDialView extends View
{
	...
	public SensorDialView(Context context, AttributeSet attrs)
	{
		this(context, attrs, R.attr.DriveScoreCircleProgressStyle);
	}

	public SensorDialView(Context context, AttributeSet attrs, int defStyleAttr)
	{
		...
		animatorX.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
		{
			...
			public void onAnimationUpdate(ValueAnimator animation)
			{
				...
				SensorDialView.this.currentXValue = (float) animation.getAnimatedValue();
				postInvalidate();
			}
		});
		...
		animatorY.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
		{
			...
			public void onAnimationUpdate(ValueAnimator animation)
			{
				SensorDialView.this.currentYValue = (float) animation.getAnimatedValue();
			}
		});
		...
		animatorG.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
		{
			...
			public void onAnimationUpdate(ValueAnimator animation)
			{
				SensorDialView.this.currentGValue = (float) animation.getAnimatedValue();
			}
		});
		...
		background = getResources().getDrawable(R.drawable.gravity_bg);
